...
(function () {
  ...
  function saferSetInnerHTML(parentElem, htmlString, allowStyleTags = false) {
    const docFrag = safelyParseHTML(
      htmlString,
      parentElem.ownerDocument,
      allowStyleTags,
    );
  ...
  */
    ...
    var END_TO_START =
      ...
      window.Range.END_TO_START;
    var START_TO_END =
      node.ownerDocument.defaultView.Range.START_TO_END ||
      window.Range.START_TO_END;
  ...
  function strToUTF8Arr(sDOMStr) {
    ...
    for (var nIdx = 0, nChrIdx = 0; nIdx < nArrLen; nChrIdx++) {
      ...
      if (nChr < 128) {
        ...
        aBytes[nIdx++] =
          252 +
          /* (nChr >>> 32) is not possible in ECMAScript! So...: */ nChr /
            1073741824;
