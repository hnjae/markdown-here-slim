...
/* biome-ignore-all lint: vendored DOMPurify bundle */
!((e, t) => {
  ...
  const J = 1,
    ...
    te = 8,
    ne = 9,
    oe = () => ("undefined" == typeof window ? null : window);
  var re = (function t() {
    const n =
    ...
    const dt = r.createElement("form"),
      ht = (e) => e instanceof RegExp || e instanceof Function,
      gt = function () {
        let e =
        ...
        if (!ft || ft !== e) {
          if (
            ...
            qe &&
              ...
              !0 === qe.svg && (w(Ne, x), w(we, P), w(we, F)),
              !0 === qe.svgFilters && (w(Ne, C), w(we, P), w(we, F)),
              !0 === qe.mathMl && (w(Ne, I), w(we, H), w(we, F))),
      ...
      Nt = (e) => "function" == typeof R && e instanceof R;
    function Rt(e, t, n) {
      u(e, (e) => {
        e.call(o, t, n, ft);
      });
